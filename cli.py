...
def get_option() -> tuple[str, argparse.Namespace] | None:
    ...
    parser.add_argument(
        ...
        help="Make a deposit\n"
             "<key>    : Private key in Hex string, '0x' prefix is optional\n"
             "<invoice>: Tornado note invoice text generated by '--note' or '--note_detail'"
    )
    parser.add_argument(
        '--withdraw',
        required=False,
